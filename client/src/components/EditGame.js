...
<div id="adminEditGame">
<div className="playerFormTop" id="gameEditTop">
    {this.props.game? "Edit Game": "Add New Game"}
</div>
<form id="editGameForm" action="" onSubmit={this.handleSubmit}>
<h6>Game Date</h6>
<input className="team-form-input" type="text" name="date"value={this.state.gameDate} onChange={this.handleChange} placeholder="Game date"/>
<div className="space"></div>
<h6>Home Team</h6>
 <input className="team-form-input" type="text" name="homeTeam"value={this.state.homeTeam} onChange={this.handleChange} placeholder="Home team name"/>
 <div className="space"></div>
 <h6>Away Team</h6>
 <input  className="team-form-input" type="text" name="awayTeam"value={this.state.awayTeam} onChange={this.handleChange} placeholder="Away team"/>
 <div className="space"></div>
 <h6>Location</h6>
 <input  className="team-form-input" type="text" name="location"value={this.state.location} onChange={this.handleChange} placeholder="Location"/>
 <div className="space"></div>
